/** Bounded, escalating process shutdown for long-lived app surfaces. */
 ...
 * @returns A controller whose normal calls coalesce and whose repeated interrupt call escalates.
 */
