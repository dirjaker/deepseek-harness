...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  DesktopCapabilities: 'desktop.md',
  DesktopCommandId: 'desktop.md',
  DesktopHost: 'desktop.md',
  DesktopMenuCommand: 'desktop.md',
  DesktopMenuItem: 'desktop.md',
  DesktopMenuRegistry: 'desktop.md',
  DesktopNotification: 'desktop.md',
  DesktopNotifications: 'desktop.md',
  DesktopServiceHandlers: 'desktop.md',
  DesktopWindowActions: 'desktop.md',
  DesktopWindowState: 'desktop.md',
  LspProvider: 'lsp.md',
